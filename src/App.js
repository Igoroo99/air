...
},
{
  ...
  const sectors = [
    ...
    imgUrl:require('./assets/sectors/sity.jpg'),
    ...
    },    
    {
      ...
      {
        name: "Энергетика",
        imgUrl:require('./assets/sectors/energetic.jpg'),
        ...
        },
        {
          ...
          imgUrl:require('./assets/sectors/utilizeishn.jpg'),
  ...
  const author = "Игорем Мирошниченко";
  ...
  return (
    <>
      <HeroBlock title="Качество атмосферного воздуха и здоровье"
                 logos={partners}                  
                 links={navLinks} />
      <Facts title="Основные факта" slides={factsSlides}/>
      <AirQuality/>
